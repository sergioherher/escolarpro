...
function write_config($domain) {
	...
	$output_path 	= '../mvc/config/config.php';
	...
	function write_database($data) {
		...
		// Config path
		//$template_path 	= 'config/production/database.php';
		$template_path 	= 'config/development/database.php';
		//$output_path 	= '../mvc/config/production/database.php';
		$output_path 	= '../mvc/config/development/database.php';
		// Open the file
