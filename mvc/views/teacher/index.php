    ...
    <div class="box-body">
        <div class="row">
            <div class="col-sm-12">
                ...
                ?>
                <h5 class="page-header"><a class="btn btn-success" href="<?php echo base_url('teacher/add') ?>">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=$this->lang->line('teacher_dni')?></th>
                        ...
                        <tbody>
                            <?php if(count($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('teacher_dni')?>">
