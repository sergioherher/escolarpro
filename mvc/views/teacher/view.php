            ...
            <div class="panel-body profile-view-dis">
                ...
                <div class="row">
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("teacher_dni")?> </span>: <?=$teacher->dni?></p>
                    </div>
                    <div class="profile-view-tab">
        ...
        <div class="modal-content">
            <div id="idCardPrint">
              ...
              <div class="modal-body" > 
                ...
                <table class="idcard-Table" style="background-color:#242424">
                    <tr>
                        <td>
                            <h4>
                        <?php
                        ...
                        <td class="row-style">
                            ...
                            <h5><?php  echo $this->lang->line("teacher_dni")." : ".$teacher->dni; ?>
                            </h5>
