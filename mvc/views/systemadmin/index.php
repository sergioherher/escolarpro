            ...
            <div class="col-sm-12">
                ...
                ?>
                    <h5 class="page-header">
                        <a class="btn btn-success" href="<?php echo base_url('systemadmin/add') ?>">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-1"><?=$this->lang->line('systemadmin_photo')?></th>
                                <th class="col-lg-2"><?=$this->lang->line('systemadmin_dni')?></th>
                                <th class="col-lg-2"><?=$this->lang->line('systemadmin_name')?></th>
                                <th class="col-lg-2"><?=$this->lang->line('systemadmin_email')?></th>
                                <th class="col-lg-1"><?=$this->lang->line('systemadmin_type')?></th>
                        ...
                        <tbody>
                            <?php if(count($systemadmins)) {$i = 1; foreach($systemadmins as $systemadmin) { if($systemadmin->systemadminID != 1 && $this->session->userdata('loginuserID') != $systemadmin->systemadminID) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('systemadmin_dni')?>">
                                        <?php echo $systemadmin->dni; ?>
                                    </td>
