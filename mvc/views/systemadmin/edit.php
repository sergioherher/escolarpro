        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="systemadmin_dni" class="col-sm-2 control-label">
                            <?=$this->lang->line("systemadmin_dni")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="dni" name="dni" value="<?=set_value('dni', $systemadmin->dni)?>" >
