            ...
            <div class="col-sm-12">
                ...
                ?>
                    <h5 class="page-header">
                        <a class="btn btn-success" href="<?php echo base_url('user/add') ?>">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1"><?=$this->lang->line('user_photo')?></th>
                                <th class="col-sm-2"><?=$this->lang->line('user_dni')?></th>
                                <th class="col-sm-2"><?=$this->lang->line('user_name')?></th>
                                <th class="col-sm-2"><?=$this->lang->line('user_email')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('user_usertype')?></th>
                                <?php if(permissionChecker('user_edit')) { ?>
                                <th class="col-sm-1"><?=$this->lang->line('user_status')?></th>
                                <?php } ?>
                        ...
                        <tbody>
                            <?php if(count($users)) {$i = 1; foreach($users as $user) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('user_dni')?>">
                                        <?php echo $user->dni; ?>
                                    </td>
