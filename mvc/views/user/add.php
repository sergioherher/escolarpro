                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="dni" class="col-sm-2 control-label">
                            <?=$this->lang->line("user_dni")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                                ...
                                <div class="col-md-12 text-justify">
                                    <div class="alert alert-dismissible alert-info">
                                        <p>
                                            ...
                                            Antes de crear un usuario debe crear un rol o tarea, esta opción se requerirá en el campo <strong> “rol de usuario”.</strong>
