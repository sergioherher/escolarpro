...
class Grade extends Admin_Controller {
	...
	public function unique_grade() {
		...
		if((int)$id) {
			...
			if(count($grade)) {
				$this->form_validation->set_message("unique_grade", "%s ya existe.");
				return FALSE;
			}
			return TRUE;
		} else {
	...
	public function unique_point() {
		...
		if((int)$id) {
			...
			if(count($grade)) {
				$this->form_validation->set_message("unique_point", "%s ya existe.");
				return FALSE;
			}
			return TRUE;
		} else {
	...
	public function unique_gradefrom() {
		...
		if((int)$id) {
			...
			if(count($grade)) {
				$this->form_validation->set_message("unique_gradefrom", "%s ya existe.");
				return FALSE;
			}
			return TRUE;
		} else {
	...
	public function unique_gradeupto() {
		...
		if((int)$id) {
			...
			if(count($grade)) {
				$this->form_validation->set_message("unique_gradeupto", "%s ya existe.");
				return FALSE;
			}
			return TRUE;
		} else {
